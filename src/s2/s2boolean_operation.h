...
//                         s2::abslmake_unique<S2PolygonLayer>(&polygon),
//                         options);
//   S2Error error;
...
//       s2::abslmake_unique<s2builderutil::PointVectorLayer>(&points),
//       s2::abslmake_unique<s2builderutil::S2PolylineVectorLayer>(&polylines),
//       s2::abslmake_unique<S2PolygonLayer>(&polygon));
