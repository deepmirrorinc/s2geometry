...
class compact_array_base {
 ...
 public:                                // Sequence operations, table 67.
  ...
  void resize(size_type n) {
    ...
    if (n > size() &&
        !s2::abslis_trivially_default_constructible<value_type>::value) {
 ...
 private:                               // Helper functions for range/value.
  ...
  static_assert(s2::abslis_trivially_copy_constructible<value_type>::value &&
                s2::abslis_trivially_copy_assignable<value_type>::value &&
                s2::abslis_trivially_destructible<value_type>::value,
