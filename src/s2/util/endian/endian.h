...
inline s2::absluint128 gbswap_128(s2::absluint128 host_int) {
...
class LittleEndian {
 public:
  ...
  static s2::absluint128 FromHost128(s2::absluint128 x) { return x; }
  static s2::absluint128 ToHost128(s2::absluint128 x) { return x; }
  ...
  static s2::absluint128 FromHost128(s2::absluint128 x) { return gbswap_128(x); }
  static s2::absluint128 ToHost128(s2::absluint128 x) { return gbswap_128(x); }
  ...
  // set all to 0.
  static s2::absluint128 Load128VariableLength(const void* p, int len) {
    if (len <= 8) {
      return s2::absluint128(Load64VariableLength(p, len));
    } else {
      return s2::abslMakeUint128(
...
FROMHOST_TYPE_MAP(s2::absluint128, s2::absluint128);
...
class GeneralFormatConverter<EndianClass, float> {
 public:
  static typename tofromhost_value_type_traits<float>::int_type FromHost(
      float v) {
    return EndianClass::FromHost32(s2::abslbit_cast<uint32>(v));
  }
  static typename tofromhost_value_type_traits<float>::int_type ToHost(
      float v) {
    return s2::abslbit_cast<float>(
        EndianClass::ToHost32(s2::abslbit_cast<uint32>(v)));
  }
};
...
class GeneralFormatConverter<EndianClass, double> {
 public:
  static typename tofromhost_value_type_traits<double>::int_type FromHost(
      double v) {
    return EndianClass::FromHost64(s2::abslbit_cast<uint64>(v));
  }
  static typename tofromhost_value_type_traits<double>::int_type ToHost(
      double v) {
    return s2::abslbit_cast<double>(
        EndianClass::ToHost64(s2::abslbit_cast<uint64>(v)));
  }
};
...
template <class EndianClass>
class GeneralFormatConverter<EndianClass, s2::absluint128> {
 public:
  static typename tofromhost_value_type_traits<s2::absluint128>::int_type
  FromHost(s2::absluint128 v) {
    return EndianClass::FromHost128(v);
  }
  static typename tofromhost_value_type_traits<s2::absluint128>::int_type ToHost(
      s2::absluint128 v) {
...
inline float LoadFloat(const char* p) {
  return s2::abslbit_cast<float>(EndianClass::ToHost32(UNALIGNED_LOAD32(p)));
}

template<typename EndianClass>
inline void StoreFloat(float value, char* p) {
  UNALIGNED_STORE32(p, EndianClass::FromHost32(s2::abslbit_cast<uint32>(value)));
}

template<typename EndianClass>
inline double LoadDouble(const char* p) {
  return s2::abslbit_cast<double>(EndianClass::ToHost64(UNALIGNED_LOAD64(p)));
}

template<typename EndianClass>
inline void StoreDouble(double value, char* p) {
  UNALIGNED_STORE64(p, EndianClass::FromHost64(s2::abslbit_cast<uint64>(value)));
}
...
template <>
inline s2::absluint128 LittleEndian::Load<s2::absluint128>(const char* p) {
  return LittleEndian::Load128(p);
}

template <>
inline void LittleEndian::Store<s2::absluint128>(s2::absluint128 value, char* p) {
  LittleEndian::Store128(p, value);
}

template <>
inline s2::absluint128 BigEndian::Load<s2::absluint128>(const char* p) {
  return BigEndian::Load128(p);
}

template <>
inline void BigEndian::Store<s2::absluint128>(s2::absluint128 value, char* p) {
