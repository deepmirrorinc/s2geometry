...
void EncodeS2PointVector(s2::abslSpan<const S2Point> points, CodingHint hint,
                         Encoder* encoder);
...
class EncodedS2PointVector {
 ...
 private:
  friend void EncodeS2PointVector(s2::abslSpan<const S2Point>, CodingHint,
                                  Encoder*);
  friend void EncodeS2PointVectorFast(s2::abslSpan<const S2Point>, Encoder*);
  friend void EncodeS2PointVectorCompact(s2::abslSpan<const S2Point>, Encoder*);
